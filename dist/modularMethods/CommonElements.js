export const htmlElement = {
    calculatorButtons: document.getElementsByClassName("calculator-buttons")[0],
    ...
    squareRootOperationButton: document.getElementsByClassName("square-root-button")[0],
    textBoxInput: document.getElementsByClassName("text-box")[0],
    advanceOperationsSection: document.getElementsByClassName("advanced-operations")[0],
    enclosingCalculatorDiv: document.getElementsByClassName("enclosing-calculator")[0],
    iconToRemoveData: document.getElementsByClassName("remove-data-icon")[0],
    iconForTrignometryFunction: document.getElementsByClassName("trignometry-function-icon")[0],
};
